...
trait Friendable
{
	public function add_friend($user_requested_id)
	{
        ...
        //nếu đã add_friend rồi thì không cho adđ nữa
    ...
    //danh sách những người đã chấp nhận kết bạn
    ...
    //danh sách những người gửi kết bạn nhưng chưa được accept
    ...
    //tìm tất cả id là bạn của user a
	public function friends_id()
	{
		return collect($this->friends())->pluck('id')->toArray();
	}
    
    //xem a có phải là bạn của b hay không
